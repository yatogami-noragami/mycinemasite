$(document).ready(function () {
    ...
    $('.uniSeat').click(function () {
        ...
        if (seatNumber.includes($(this).html() + ',')) {
            ...
            $('#seatNumber').append(`<button class="btn btn-success fw-bold m-3" id="Selected${seat}">${seat}</button>`);
            totalAmount += singleSeatAmount;
            $('#totalAmount').html(totalAmount);
        }
    });
    ...
    $('.coupleSeat').click(function () {
        ...
        if (seatNumber.includes($(this).html() + ',')) {
            ...
            seatNumber += $(this).html() + ',';
            $('#seatNumber').append(`<button class="btn btn-pink fw-bold m-3" id="Selected${seat}">${seat}</button>`);
            totalAmount += coupleSeatAmount;
            $('#totalAmount').html(totalAmount);
        }
    });
